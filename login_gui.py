...
#Logo
logo_image = tk.PhotoImage(file="/Users/User/Pictures/Saved Pictures/SpeedRunners_linesbckgrd.png")
...
eye_button = tk.Button(login_entry_frame, text="👁", command=login_toggle_password_visibility, font=("yu gothic ui", 11))
...
eye_button = tk.Button(register_frame, text="👁", command=register_toggle_password_visibility, font=("yu gothic ui", 11))
